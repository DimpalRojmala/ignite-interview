package com.example.producerservice.twitterapis;
...
public class TwitterAPI {
     ...
     * */
     public static String search(String searchString, String bearerToken) throws IOException, URISyntaxException {
        ...
        // queryParameters.add(new BasicNameValuePair("genre", searchString));
